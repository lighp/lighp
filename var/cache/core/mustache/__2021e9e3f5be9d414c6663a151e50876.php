...
class __2021e9e3f5be9d414c6663a151e50876 extends core\mustache\Template
{
    ...
    public function renderInternal(core\mustache\Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= $this->section4dccc228f9951c571b48c28fb3bca682($context, $indent, $context->find('leadingItems'));
        $buffer .= $indent . '	</tbody>';
        $buffer .= "\n";
        $buffer .= $indent . '</table>';
        $buffer .= "\n";
    ...
    private function section4dccc228f9951c571b48c28fb3bca682(core\mustache\Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
			...
			<tr>
				...
				<td>
					<div class="btn-group">
						<a class="btn btn-danger" href="portfolio-leading-remove-{{id}}.html"><i class="icon-trash icon-white"></i>&nbsp;Supprimer {{id}}abc</a>
					</div>
				</td>
			</tr>
		';
