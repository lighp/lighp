...
class __f436ac62760783de7ac5a5c6a682c52d extends core\mustache\Template
{
    ...
    public function renderInternal(core\mustache\Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= '" placeholder="Emplacement" pattren="[a-zA-Z]+" required><span class="help-inline">(l\'emplacement définit à quel endroid de la page l\'item sera mis en avant, par exemple : <em>featurette</em>)</span>';
        $buffer .= "\n";
        $buffer .= $indent . '		</div>';
        $buffer .= "\n";
        $buffer .= $indent . '	</div>';
