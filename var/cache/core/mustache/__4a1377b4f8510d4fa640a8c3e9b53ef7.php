...
class __4a1377b4f8510d4fa640a8c3e9b53ef7 extends core\mustache\Template
{
    ...
    public function renderInternal(core\mustache\Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        // 'projects' section
        $buffer .= $this->section4daa42b63f48d3e37f71384238e0af90($context, $indent, $context->find('projects'));
        $buffer .= $indent . '	</tbody>';
        $buffer .= "\n";
        $buffer .= $indent . '</table>';
        $buffer .= "\n";
    ...
    private function section4daa42b63f48d3e37f71384238e0af90(core\mustache\Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
			<tr>
				...
				<td>
					<div class="btn-group">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="portfolio-leading-insert-project-{{name}}.html"><i class="icon-star"></i> Mettre en avant</a></li>
							<li class="divider"></li>
							<li><a href="portfolio-galleries-show-{{name}}.html"><i class="icon-picture"></i> Gérer la galerie</a></li>
		...
		';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= "\n";
                $buffer .= $indent . '							<li><a href="portfolio-leading-insert-project-';
                $value = $context->find('name');
                if (!is_string($value) && is_callable($value)) {
                    $value = $this->mustache
                        ->loadLambda((string) call_user_func($value))
                ...
                $buffer .= htmlspecialchars($value, ENT_COMPAT, 'UTF-8');
                $buffer .= '.html"><i class="icon-star"></i> Mettre en avant</a></li>';
                $buffer .= "\n";
                $buffer .= $indent . '							<li class="divider"></li>';
                $buffer .= "\n";
                $buffer .= $indent . '							<li><a href="portfolio-galleries-show-';
                $value = $context->find('name');
                if (!is_string($value) && is_callable($value)) {
                    $value = $this->mustache
                        ->loadLambda((string) call_user_func($value))
