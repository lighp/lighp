...
class __4bb836377f62314e720c45d2b156eb60 extends core\mustache\Template
{
    ...
    public function renderInternal(core\mustache\Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        // 'featuretteProjects' section
        $buffer .= $this->sectionE734b2c4511a751a5589d5e82e4fde2a($context, $indent, $context->find('featuretteProjects'));
    ...
    private function section1f2faf154955d06db1129bb4183443f9(core\mustache\Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
			<img class="featurette-image pull-{{#pullRight?}}right{{/pullRight?}}{{^pullRight?}}left{{/pullRight?}}" src="img/portfolio/project/large/{{name}}.png">
			';
            $buffer .= $this->mustache
                ->loadLambda((string) call_user_func($value, $source, $this->lambdaHelper))
                ->renderInternal($context, $indent);
            ...
            foreach ($values as $value) {
                ...
                $buffer .= '" src="img/portfolio/project/large/';
                $value = $context->find('name');
                if (!is_string($value) && is_callable($value)) {
                    $value = $this->mustache
                        ->loadLambda((string) call_user_func($value))
    ...
    private function sectionE734b2c4511a751a5589d5e82e4fde2a(core\mustache\Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
		<div class="featurette">
			...
			<p><a class="btn btn-large btn-primary" href="project-{{name}}.html">En savoir plus &raquo;</a></p>
		</div>
	...
	';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= "\n";
                // 'hasImage' section
                $buffer .= $this->section1f2faf154955d06db1129bb4183443f9($context, $indent, $context->find('hasImage'));
                ...
                $buffer .= '</p>';
                $buffer .= "\n";
                $buffer .= $indent . '			<p><a class="btn btn-large btn-primary" href="project-';
                $value = $context->find('name');
                if (!is_string($value) && is_callable($value)) {
                    $value = $this->mustache
                        ->loadLambda((string) call_user_func($value))
