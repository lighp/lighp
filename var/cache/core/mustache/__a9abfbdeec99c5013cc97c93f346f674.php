...
class __a9abfbdeec99c5013cc97c93f346f674 extends core\mustache\Template
{
    ...
    public function renderInternal(core\mustache\Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        // 'projects' section
        $buffer .= $this->section8b88aa42a15a84fff8809922f5f0fc1f($context, $indent, $context->find('projects'));
        $buffer .= $indent . '	</tbody>';
        $buffer .= "\n";
        $buffer .= $indent . '</table>';
        $buffer .= "\n";
    ...
    private function section8b88aa42a15a84fff8809922f5f0fc1f(core\mustache\Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
			<tr>
