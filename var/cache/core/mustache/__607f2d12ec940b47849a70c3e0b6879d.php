...
class __607f2d12ec940b47849a70c3e0b6879d extends core\mustache\Template
{
    ...
    public function renderInternal(core\mustache\Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= $this->section7c56bc31dcb42dbac361115de68bc0cf($context, $indent, $context->find('leadingProjects'));
    ...
    private function section7c56bc31dcb42dbac361115de68bc0cf(core\mustache\Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
