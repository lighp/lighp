...
class __ed911ebf77dbf19ce5add8d990b23f99 extends core\mustache\Template
{
    ...
    public function renderInternal(core\mustache\Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        // 'projects' section
        $buffer .= $this->section848949b984395b2977e80d640a9e2bb0($context, $indent, $context->find('projects'));
        $buffer .= $indent . '	</tbody>';
        $buffer .= "\n";
        $buffer .= $indent . '</table>';
        $buffer .= "\n";
    ...
    private function section848949b984395b2977e80d640a9e2bb0(core\mustache\Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
			<tr>
				...
				<td>
					<div class="btn-group">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="portfolio-galleries-{{name}}.html"><i class="icon-plus-sign"></i> Insérer un item dans la galerie</a></li>
							<li class="divider"></li>
