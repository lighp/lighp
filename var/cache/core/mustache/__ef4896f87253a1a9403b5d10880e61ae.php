...
class __ef4896f87253a1a9403b5d10880e61ae extends core\mustache\Template
{
    ...
    public function renderInternal(core\mustache\Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= $this->sectionCf862dd11818d1da6762f9c047fd9de9($context, $indent, $context->find('leadingItems'));
        $buffer .= $indent . '	</tbody>';
        $buffer .= "\n";
        $buffer .= $indent . '</table>';
        $buffer .= "\n";
    ...
    private function sectionCf862dd11818d1da6762f9c047fd9de9(core\mustache\Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
			...
			<tr>
				...
				<td>
					<div class="btn-group">
						<a class="btn btn-danger" href="portfolio-leading-delete-{{item.id}}.html"><i class="icon-trash icon-white"></i>&nbsp;Supprimer</a>
					</div>
				</td>
			</tr>
		';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= "\n";
                $buffer .= $indent . '						<a class="btn btn-danger" href="portfolio-leading-delete-';
