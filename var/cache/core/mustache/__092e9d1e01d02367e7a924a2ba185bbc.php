...
class __092e9d1e01d02367e7a924a2ba185bbc extends core\mustache\Template
{
    ...
    public function renderInternal(core\mustache\Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= $this->section0c18082bce5a1694f1cd7d33f783fc2f($context, $indent, $context->find('leadingItems'));
        $buffer .= $indent . '	</tbody>';
        $buffer .= "\n";
        $buffer .= $indent . '</table>';
        $buffer .= "\n";
    ...
    private function section0c18082bce5a1694f1cd7d33f783fc2f(core\mustache\Context $context, $indent, $value) {
        $buffer = '';
