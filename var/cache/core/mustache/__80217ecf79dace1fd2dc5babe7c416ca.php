...
class __80217ecf79dace1fd2dc5babe7c416ca extends core\mustache\Template
{
    ...
    public function renderInternal(core\mustache\Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= $indent . '	<div class="control-group">';
        $buffer .= "\n";
        $buffer .= $indent . '		<label class="control-label" for="galleryItem-kind">Type de l\'item</label>';
        $buffer .= "\n";
        $buffer .= $indent . '		<div class="controls">';
        $buffer .= "\n";
        $buffer .= $indent . '			<select name="galleryItem-kind" id="galleryItem-kind">';
        $buffer .= "\n";
        $buffer .= $indent . '				<option value="">Détection automatique</option>';
        $buffer .= "\n";
        // 'galleryItemKinds' section
        $buffer .= $this->section466bfb85581e54fd4f81b14ef28f2e90($context, $indent, $context->find('galleryItemKinds'));
        ...
        $buffer .= htmlspecialchars($value, ENT_COMPAT, 'UTF-8');
        $buffer .= '" placeholder="Source" class="input-xxlarge" required><span class="help-inline">(entrez une URL ou un chemin vers un fichier)</span>';
        $buffer .= "\n";
        $buffer .= $indent . '		</div>';
        $buffer .= "\n";
        $buffer .= $indent . '	</div>';
