...
class __367c06dd74e7122cb818dfa972223716 extends core\mustache\Template
{
    ...
    public function renderInternal(core\mustache\Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= $this->section4416a5a6da028cfc62e42666e476ccda($context, $indent, $context->find('leadingItems'));
        $buffer .= $indent . '	</tbody>';
        $buffer .= "\n";
        $buffer .= $indent . '</table>';
        $buffer .= "\n";
    ...
    private function section4416a5a6da028cfc62e42666e476ccda(core\mustache\Context $context, $indent, $value) {
        $buffer = '';
