...
class __c875124a0ad0fa1405ac1bf748dc6488 extends core\mustache\Template
{
    ...
    public function renderInternal(core\mustache\Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= $this->section27c8cc627857fe3312ce1e6007e57380($context, $indent, $context->find('leadingItems'));
        $buffer .= $indent . '	</tbody>';
        $buffer .= "\n";
        $buffer .= $indent . '</table>';
        $buffer .= "\n";
    ...
    private function section27c8cc627857fe3312ce1e6007e57380(core\mustache\Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
			<tr>
				<td><a href="portfolio-{{leadingKind}}-{{name}}.html">{{data.title}}</a></td>
				<td>{{item.kind}}</td>
				<td>{{item.place}}</td>
				<td>
					<div class="btn-group">
