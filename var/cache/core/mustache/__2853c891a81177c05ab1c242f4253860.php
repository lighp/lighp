...
class __2853c891a81177c05ab1c242f4253860 extends core\mustache\Template
{
    ...
    public function renderInternal(core\mustache\Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= $this->section798b2b78186776ab549e9e4a74931a40($context, $indent, $context->find('leadingItems'));
        $buffer .= $indent . '	</tbody>';
        $buffer .= "\n";
        $buffer .= $indent . '</table>';
        $buffer .= "\n";
    ...
    private function section798b2b78186776ab549e9e4a74931a40(core\mustache\Context $context, $indent, $value) {
        $buffer = '';
