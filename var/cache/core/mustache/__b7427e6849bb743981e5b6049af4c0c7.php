...
class __b7427e6849bb743981e5b6049af4c0c7 extends core\mustache\Template
{
    ...
    public function renderInternal(core\mustache\Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        // 'projects' section
        $buffer .= $this->section52530ddd373941d41cf57bf82084cf69($context, $indent, $context->find('projects'));
        $buffer .= $indent . '	</tbody>';
        $buffer .= "\n";
        $buffer .= $indent . '</table>';
        $buffer .= "\n";
    ...
    private function section52530ddd373941d41cf57bf82084cf69(core\mustache\Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
			<tr>
