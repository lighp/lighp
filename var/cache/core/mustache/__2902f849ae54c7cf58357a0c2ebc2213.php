...
class __2902f849ae54c7cf58357a0c2ebc2213 extends core\mustache\Template
{
    ...
    public function renderInternal(core\mustache\Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= $this->section39d41acae82991976b3c11ea87e694c6($context, $indent, $context->find('leadingProjects'));
    ...
    private function section39d41acae82991976b3c11ea87e694c6(core\mustache\Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
