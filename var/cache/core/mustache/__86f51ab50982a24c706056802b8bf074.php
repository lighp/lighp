...
class __86f51ab50982a24c706056802b8bf074 extends core\mustache\Template
{
    ...
    public function renderInternal(core\mustache\Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= $this->sectionA3a713f190936ef0553aca082d5df6ca($context, $indent, $context->find('leadingProjects'));
    ...
    private function sectionA3a713f190936ef0553aca082d5df6ca(core\mustache\Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
