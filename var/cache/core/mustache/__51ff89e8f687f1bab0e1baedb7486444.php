...
class __51ff89e8f687f1bab0e1baedb7486444 extends core\mustache\Template
{
    ...
    public function renderInternal(core\mustache\Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= '" placeholder="Emplacement" pattren="[a-zA-Z]+" required><span class="help-inline">(l\'emplacement définit à quel endroid de la page l\'item sera mis en avant, par exemple : <em>index</em>)</span>';
        $buffer .= "\n";
        $buffer .= $indent . '		</div>';
        $buffer .= "\n";
        $buffer .= $indent . '	</div>';
