...
class __2d49389b257d7365c9e5016d35c77c9f extends core\mustache\Template
{
    ...
    public function renderInternal(core\mustache\Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= $this->section301e119b0243428fdd41bb80eeeb4548($context, $indent, $context->find('leadingProjects'));
    ...
    private function section301e119b0243428fdd41bb80eeeb4548(core\mustache\Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
	...
	';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= "\n";
                $buffer .= "\n";
                $buffer .= $indent . '		<hr class="featurette-divider clearfix"/>';
                $buffer .= "\n";
                $context->pop();
            }
        }
