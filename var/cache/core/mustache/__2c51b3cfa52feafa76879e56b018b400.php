...
class __2c51b3cfa52feafa76879e56b018b400 extends core\mustache\Template
{
    ...
    public function renderInternal(core\mustache\Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= '" placeholder="Emplacement" pattern="[A-Za-z]+" required><span class="help-inline">(l\'emplacement définit à quel endroid de la page l\'item sera mis en avant, par exemple : <em>index</em>)</span>';
        $buffer .= "\n";
        $buffer .= $indent . '		</div>';
        $buffer .= "\n";
        $buffer .= $indent . '	</div>';
