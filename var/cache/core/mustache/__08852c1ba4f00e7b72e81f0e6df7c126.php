...
class __08852c1ba4f00e7b72e81f0e6df7c126 extends core\mustache\Template
{
    ...
    public function renderInternal(core\mustache\Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= $this->section73e5356dde9b4930aae0b780a28789c7($context, $indent, $context->find('leadingProjects'));
    ...
    private function sectionA28b1cbd22fcbe8942db32d564803f40(core\mustache\Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
			<img class="featurette-image pull-{{#pullRight?}}right{{/pullRight?}}{{^pullRight?}}left{{/pullRight?}}" src="img/portfolio/{{item.kind}}/large/{{data.name}}.png">
			';
            $buffer .= $this->mustache
                ->loadLambda((string) call_user_func($value, $source, $this->lambdaHelper))
                ->renderInternal($context, $indent);
    ...
    private function section73e5356dde9b4930aae0b780a28789c7(core\mustache\Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
		<div class="featurette">
			...
			<p><a class="btn btn-large btn-primary" href="{{item.kind}}-{{data.name}}.html">En savoir plus &raquo;</a></p>
		</div>
	...
	';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->sectionA28b1cbd22fcbe8942db32d564803f40($context, $indent, $context->findDot('data.hasImage'));
